...
namespace ChelosSpriteAnimator
{
    public class MainWindowViewModel : ViewModel
    {
        public MainWindowViewModel()
        {
            ...
            SpriteEditor = new EditorViewModel();
        ...
        private Document<SpriteFile> _document;

        public Document<SpriteFile> Document
        {
            get => _document;
            private set
            {
        ...
        private EditorViewModel _spriteEditor;

        public EditorViewModel SpriteEditor
        {
            get => _spriteEditor;
        ...
        public async Task New()
        {
            ...
            {
                Document = Document<SpriteFile>.New();
        ...
        {
            Document = Document<SpriteFile>.Load(filePath);
            SpriteEditor.SetDocumentContent(Document);
            Document.IsSaved = true;
            UpdateTitle();
        }
        ...
        public async Task<bool> ConfirmSave()
        {
            if (Document != null && !Document.IsSaved)
            {
                ...
                var result = await messageService.ShowAsync("Save changes?", "Save", MessageButton.YesNoCancel,
