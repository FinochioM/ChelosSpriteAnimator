...
namespace ChelosSpriteAnimator.Sprites
{
    ...
    public class KeyFrameAnimationViewModel : ViewModel
    {
        ...
        public ObservableCollection<KeyFrameViewModel> KeyFrames { get; set; } =
            new ObservableCollection<KeyFrameViewModel>();
        ...
        public static KeyFrameAnimationViewModel FromAnimation(string name, KeyFrameAnimationCycle cycle,
            Func<string> getImagePath, Func<int, Rectangle> getRectangle)
        {
            var keyFrameViewModels = cycle.Frames.Select(k => new KeyFrameViewModel(k, getImagePath, getRectangle));
